...
urlpatterns = [
    ...
    path('Bathrooms/Ratings/Create/', MakeARating),
    ...
    path('UpdateAddresses/', UpdateAddress),
    path('UpdateUsers/', UpdateUser),
    path('UpdateBathrooms/', UpdateBathroom),
    path('UpdateTimeSlot/', UpdateTimeSlot),
    path('DeleteAddress/', DeleteAddress),
    path('DeleteBathroom/', DeleteBathroom),
    path('DeleteTimeSlot/', DeleteTimeSlot),
