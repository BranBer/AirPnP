...
urlpatterns = [
    ...
    path('User/Addresses/API/<int:user>/<str:address_line1>/<str:address_line2>/<str:city>/<str:state>/<int:zip>/<longitude>/<latitude>/', PostToAddressesAPI),
    ...
    path('User/PaymentInfo/API/<int:user>/<str:email>/', PostToPaymentInfoAPI),
    ...
    path('Bathrooms/Ratings/API', Ratings_API, name = 'Ratings_API'),
     path('Bathrooms/Ratings/API/<int:user>/<int:bathroom_id>/<int:score>/<str:title>/<str:description>/', PostToRatingsAPI),
